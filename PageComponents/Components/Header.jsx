            ...
            <div class="header-left">
              <div class="logo-thumbnail logo-custom-css">
                <div class="logo-light">
                  ...
                  <img src="/logo/real-state.png" alt="nft-logo" />
                </div>
                  ...
                  <ul class="mainmenu">
                    ...
                    <li>
                      ...
                      <ul class="submenu">
                        ...
                        <li>
                          <Link class="live-expo" href="/explore">
                            Explore
                          </Link>
                        </li>
                      </ul>
                    ...
                    <div class="icon-box">
                      ...
                      <div class="rn-dropdown">
                        <div class="rn-inner-top">
                          <h4 class="title">
                            <a href="details">Christopher William</a>
                          </h4>
                          <span>
