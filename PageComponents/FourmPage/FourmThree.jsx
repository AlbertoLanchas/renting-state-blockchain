    ...
    <div class="nu-community-area rn-section-gapTop">
      <div class="container">
        <div class="row g-5">
              ...
              <div class="single-community-box">
                ...
                <div class="community-content">
                  ...
                  <div class="rn-community-footer">
                    ...
                    <div class="answer">
                      <a href="#" class="btn btn-primary-alta rounded">
                        Answer
                      </a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4">
            <a class="btn btn-primary add-community" href="#">
              Start New Topic <i class="feather-plus"></i>
            </a>
            ...
            <div class="rbt-single-widget widget_categories mt--30">
              ...
              <div class="inner">
                <ul class="category-list ">
                  <li>
                    <a href="#">
                      <span class="left-content">Development</span>
                  ...
                  <li>
                    <a href="#">
                      <span class="left-content">Marketing</span>
                  ...
                  <li>
                    <a href="#">
                      <span class="left-content">App Development</span>
